...
function page() {
  ...
  return (
    <div className="flex justify-center items-center h-[100vh] bg-gray-50">
      <div className="flex border border-gray-200 shadow-md rounded-lg bg-white h-[50%] items-center justify-center flex-col gap-12 px-20">
        <p className="text-black text-4xl font-bold">TodoList</p>
