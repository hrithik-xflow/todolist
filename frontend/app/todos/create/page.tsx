    ...
    return(
        <div>
            ...
            <div className="flex flex-col gap-2 items-start w-[70%]">
                <input placeholder="Title" {...register('title',{required:'Title is required'})} className="font-bold text-3xl border rounded border-gray-500 w-[100%] px-2 py-1" />
            ...
            <div>
                <textarea placeholder="Description" {...register('description',{required:'Description is required'})} className="text-md border border-gray-500 rounded w-[70%]  text-left text-wrap px-2 py-1" />
            </div>
            </div>
            <button type="submit" className="text-white px-5 py-1 bg-blue-500 rounded px-2 cursor-pointer mt-5">Create</button>
